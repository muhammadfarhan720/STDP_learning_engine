...
HD_PWD='C:/Users/aarya/Desktop/Vivado_Directory_Local/SimpleDataPath/SimpleDataPath.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OptimizedLearningEngine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OptimizedLearningEngine.tcl
