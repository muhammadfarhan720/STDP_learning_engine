...
HD_PWD='C:/Users/aarya/Desktop/Vivado_Directory_Local/SimpleDataPath/SimpleDataPath.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OptimizedLearningEngine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OptimizedLearningEngine.tcl -notrace
