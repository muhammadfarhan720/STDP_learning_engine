...
HD_PWD='C:/Users/aarya/Desktop/Vivado_Directory_Local/SimpleDataPath/SimpleDataPath.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log BasicLearningEngine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BasicLearningEngine.tcl
