...
HD_PWD='C:/Users/aarya/Desktop/Vivado_Directory_Local/SimpleDataPath/SimpleDataPath.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log BasicLearningEngine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BasicLearningEngine.tcl -notrace
